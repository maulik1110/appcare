...
const Vision = () => {
  return (
    <div className='w-full  mt-4 h-[60vh] flex justify-between item-center '>
        <img className='rounded-xl object-cover w-1/2 h-full' src={vision} alt="" />
        <div className="content px-5">
        <h1 className='font-bold text-7xl'>Our Vision!</h1>
